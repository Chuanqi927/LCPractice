...
//Step 0:
// Get positive target value (step to get negative target is the same as to get positive value due to symmetry).
//Step 1:
// Find the smallest step that the summation from 1 to step just exceeds or equalstarget.
//Step 2:
// Find the difference between sum and target.
...
//Step 2.2:
// If the difference value is odd, we need to increase the step until the difference is even (at most 2 more steps needed).
